    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.select(function (state) { return state.admin.ui.optimistic; })];
            case 2:
                ...
                return [4 /*yield*/, effects_1.all([
                        ...
                        effects_1.put({ type: fetchActions_1.FETCH_START }),
                    ])];
            case 3:
                _b.sent();
                return [4 /*yield*/, effects_1.call(dataProvider, restType, meta.resource, payload)];
            case 4:
                response = _b.sent();
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        meta: __assign({}, meta, onSuccess, { fetchResponse: restType, fetchStatus: fetchActions_1.FETCH_END }),
                    })];
            case 5:
                _b.sent();
                return [4 /*yield*/, effects_1.put({ type: fetchActions_1.FETCH_END })];
            case 6:
                _b.sent();
                return [3 /*break*/, 14];
            case 7:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        requestPayload: payload,
                        meta: __assign({}, meta, onFailure, { fetchResponse: restType, fetchStatus: fetchActions_1.FETCH_ERROR }),
                    })];
            case 8:
                _b.sent();
                return [4 /*yield*/, effects_1.put({ type: fetchActions_1.FETCH_ERROR, error: error_1 })];
            case 9:
                _b.sent();
                return [3 /*break*/, 14];
            case 10: return [4 /*yield*/, effects_1.cancelled()];
            case 11:
                if (!_b.sent()) return [3 /*break*/, 13];
                return [4 /*yield*/, effects_1.put({ type: fetchActions_1.FETCH_CANCEL })];
            case 12:
                _b.sent();
                return [2 /*return*/];
