...
export function handleFetch(dataProvider, action) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                return [4 /*yield*/, call(dataProvider, restType, meta.resource, payload)];
            case 4:
                response = _b.sent();
                ...
                return [4 /*yield*/, put({
                        ...
                        meta: __assign({}, meta, onSuccess, { fetchResponse: restType, fetchStatus: FETCH_END }),
                    })];
            case 5:
                _b.sent();
            ...
            case 7:
                ...
                return [4 /*yield*/, put({
                        ...
                        requestPayload: payload,
                        meta: __assign({}, meta, onFailure, { fetchResponse: restType, fetchStatus: FETCH_ERROR }),
                    })];
            case 8:
                _b.sent();
